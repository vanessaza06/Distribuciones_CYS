...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function abrirModalNueva() {
    console.log("[marcas.js] Click en Nueva marca detectado.");
    const urls = getUrls();
    ...
    console.log("[marcas.js] Modal abierto correctamente.");
  }
  ...
  if (btnNuevaMarca) {
    console.log("[marcas.js] Botón #btnNuevaMarca encontrado, listener asignado.");
  ...
  // Delegación adicional en <body>: red de seguridad por si el botón
  // se vuelve a pintar dinámicamente y pierde su listener directo.
  document.body.addEventListener("click", function (e) {
    if (e.target.closest("#btnNuevaMarca")) {
      abrirModalNueva();
    }
  });
