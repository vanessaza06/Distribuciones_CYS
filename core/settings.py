...
SECRET_KEY = 'django-insecure-_$sb+_^d@5%ka**#r0dxnyegte(aw854zz_^(@r2$alyo%*o0+'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app.context_processors.aside_stats',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'distribuciones_cys'),
...
DEFAULT_FROM_EMAIL = 'no-reply@cysltda.com'
